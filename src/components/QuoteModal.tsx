...
import { X, Check, ArrowLeft, Send, CheckCircle2, Loader2 } from 'lucide-react';
              ...
              {step === 1 && (
                <div className="space-y-5">
                  ...
                  <div className="space-y-2">
                    <label htmlFor="qm-urg" className="text-sm text-muted-foreground">{t('quote.urgencyLabel')}</label>
                    <select id="qm-urg" value={urgencia} onChange={(e) => setUrgencia(e.target.value as Urgencia)} className={inputCls}>
