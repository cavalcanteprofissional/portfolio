  ...
  return (
    <section id="skills" className="py-24">
      <div className="section-container">
        <SectionHeader title={t('sections.skills')} spacing="mb-16" />

        <Stagger stagger={STAGGER.row} className="grid md:grid-cols-2 gap-4 mb-12">
          {skillCategories.map((category) => {
            ...
            return (
              <StaggerItem key={category.id}>
                <div className="bg-card/80 backdrop-blur-sm rounded-soft-xl border border-border/30 overflow-hidden shadow-soft hover:shadow-soft-lg transition-all">
                  <button
