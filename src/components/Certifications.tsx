...
const certifications = [
  {
    ...
    icon: 'file-text',
    url: '/portfolio/documents/banco_dados.pdf',
  },
  {
    id: '9',
    ...
    yearKey: 'cert.9.year',
    icon: 'wrench',
    url: '/portfolio/documents/engenharia_software.pdf',
  },
  {
    id: '8',
    ...
    yearKey: 'cert.8.year',
    icon: 'book-open',
    url: '/portfolio/documents/ads_unifor.pdf',
  },
  {
    id: '7',
    ...
    yearKey: 'cert.7.year',
    icon: 'database',
    url: '/portfolio/documents/ciencia_dados_uece.pdf',
  },
  {
    id: '6',
    ...
    yearKey: 'cert.6.year',
    icon: 'terminal',
    url: '/portfolio/documents/devops_ada.pdf',
  },
  {
    id: '5',
    ...
    yearKey: 'cert.5.year',
    icon: 'code',
    url: '/portfolio/documents/fullstack_iel.pdf',
  },
  {
    id: '4',
    ...
    yearKey: 'cert.4.year',
    icon: 'graduation-cap',
    url: '/portfolio/documents/ciencias_sociais_ufc.pdf',
  },
  {
    id: '3',
    ...
    yearKey: 'cert.3.year',
    icon: 'gamepad',
    url: '/portfolio/documents/pjd_estacio.pdf',
  },
  {
    id: '2',
    ...
    yearKey: 'cert.2.year',
    icon: 'palette',
    url: '/portfolio/documents/design_grafico.pdf',
  },
  {
    id: '1',
    ...
    yearKey: 'cert.1.year',
    icon: 'laptop-code',
    url: '/portfolio/documents/montagem_manutencao.pdf',
  },
];
