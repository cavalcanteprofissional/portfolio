...
export const translations = {
  pt: {
    ...
    quote: {
      ...
      urgency: { normal: "Normal", urgente: "Urgente", muito: "Muito urgente" },
      description: "Descreva seu projeto (opcional)",
      estimate: "Estimativa",
      submit: "Confirmar solicitação de orçamento",
      ...
      orDirect: "ou entre em contato direto",
      successTitle: "Solicitação recebida!",
      successBody: "Seu orçamento foi registrado. Guarde o código abaixo para acompanhamento.",
      successNote: "Você receberá a proposta por email após a análise.",
    },
    admin: {
  ...
  en: {
    ...
    quote: {
      ...
      urgency: { normal: "Normal", urgente: "Urgent", muito: "Very urgent" },
      description: "Describe your project (optional)",
      estimate: "Estimate",
      submit: "Confirm quote request",
      ...
      successBody: "Your quote has been registered. Keep the code below to track it.",
      successNote: "You will receive the proposal by email after review.",
    },
    admin: {
  ...
  es: {
    ...
    quote: {
      ...
      urgency: { normal: "Normal", urgente: "Urgente", muito: "Muy urgente" },
      description: "Describe tu proyecto (opcional)",
      estimate: "Estimación",
      submit: "Confirmar solicitud de presupuesto",
      ...
      successBody: "Tu presupuesto ha sido registrado. Guarda el código para seguimiento.",
      successNote: "Recibirás la propuesta por email tras el análisis.",
    },
    admin: {
